"use client";
import { motion } from "framer-motion"; import { Mail, Phone, Linkedin, Send, MessageSquare, Code, MapPin } from "lucide-react";
...
export function Contact() {
  const contactInfo = [
    ...
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      value: "linkedin.com/in/sneha1127",
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-purple-900/40 to-blue-900/40 backdrop-blur-xl border border-purple-500/20 rounded-3xl p-8">
                <div className="space-y-6">
                  ...
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 border-0 shadow-[0_0_30px_rgba(168,85,247,0.3)] hover:shadow-[0_0_40px_rgba(168,85,247,0.5)] transition-all"
                  >
